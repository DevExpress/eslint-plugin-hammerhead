...
module.exports = {
    ...
    configs:     {
        recommended: {
            rules: {
                'no-restricted-globals':    [2, 'Object', 'JSON', 'Date'],
                'no-restricted-properties': [2,
                    ...
                    },
                    {
                        ...
                        'message':  'Please use the "contentWindowGetter" from native methods instead.'
                    },
                    {
                    ...
                    {
                        'property': 'parentNode',
                        'message':  'Please use the "nodeParentNodeGetter" from native methods instead.'
                    },
                    {
                        'property': 'childNodes',
                        'message':  'Please use the "nodeChildNodesGetter" from native methods instead.'
                    },
                    {
                        'property': 'now',
                        'message':  'Please use the "dateNow" or "performanceNow" from native methods instead.'
                    }
                ]
            }
        }
